...
//		
//		System.err.println("------값 확인하기 ------");
//		System.out.println("method : "+method);
//		System.out.println("uri : "+uri);
//		System.out.println("queryString : "+ queryStirng);
...
//		}
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("비밀번호 : "+ req.getParameter("passeword"));
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//http 통신 중 get 요청이 발생했을 때 자동으로 호출되는 메서드
		//doget과 마찬가지로 내장객체 request 와 response를 매개값으로 전달받습니다.
		//post방식으로 요청이 들어왔을 때, 함께 전송된 파라미터를 얻으실때는
		//인코딩 작업을 다시 거치셔야 합니다.
		
		req.setCharacterEncoding("UTF-8");
		
		System.out.println(" doPost메서드가 호출됨");
